public class SimpleHashTable
{
    ...
    public void put(String key, Player value)
    {
        ...
        if(isOccupied(hashedKey))
        {
            System.out.println("Duplicate key found at " + hashedKey + " Element cannot be placed.");
        }
        else
        {
    ...
    public Player remove(String key) {
        ...
        Player removedValue = hashTable[hashedKey].value;
        ...
        for (StoredPlayer storedPlayer : oldTable) {
            if (storedPlayer != null) {
                StoredPlayer player = storedPlayer;
                put(player.key, player.value);
            }
        }
